package com.riverssen.nucleus.net.server;

import com.riverssen.nucleus.consensys.DownloadedBlock;
import com.riverssen.nucleus.event.BlockNotificationEvent;
import com.riverssen.nucleus.net.p2p.udp.PacketSendReceive;
...
public class Server
{
    private static final Logger Logger = com.riverssen.nucleus.util.Logger.get("Server");
