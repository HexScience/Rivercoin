package com.riverssen.nucleus.crypto.ec;

import com.riverssen.nucleus.exceptions.ECLibException;
import com.riverssen.nucleus.exceptions.ECPointUnobtainableException;
import com.riverssen.nucleus.exceptions.ECPrivateKeyInconstructableException;
...
public class ECLib
{
    private static final Logger Logger = com.riverssen.nucleus.util.Logger.get("ECLib");
