...
public class VAOMesh
{
    ...
    public VAOMesh(String name, String extention) throws IOException, NKMinerException
    {
    ...
    public static Mesh Mesh(String name, String extention) throws IOException, NKMinerException
    {
        DataInputStream stream = new DataInputStream(Start.class.getClass().getResourceAsStream("/mining/" + name + "." + extention));
        ...
        System.out.println(mesh.mFaces().get(0).mNumIndices());
...
//        }
    ...
    public VAOMesh(float vertices[], int indices[])
    {
