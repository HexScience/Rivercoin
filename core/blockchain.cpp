...
{
    orphanedBlocks.erase(std::remove_if(orphanedBlocks.begin(), orphanedBlocks.end(), [this](Block* b) { return b->getIndex() < subtractUnsigned(this->activeBlock(), 1);}), orphanedBlocks.end());
}
